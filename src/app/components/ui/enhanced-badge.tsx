...
const StatusBadge = React.forwardRef<HTMLDivElement, StatusBadgeProps>(({ status, children, ...props }, ref) => {
  const statusConfig = {
    online: { variant: "success" as const, text: "Online" },
    offline: { variant: "secondary" as const, text: "Offline" },
    busy: { variant: "destructive" as const, text: "Busy" },
...
export { EnhancedBadge, StatusBadge, badgeVariants }
